...
logo='''
\033[1;94m ┈┈┈┈╱▔▔▔▔╲┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈╱▔▔▔▔╲┈┈┈┈
\033[1;94m ┈┈┈▕▕KRISHNA▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕B4 M4▏▏┈┈┈
\033[1;94m ┈┈┈▕▕▂╱╲▂▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕▂╱╲▂▏▏┈┈┈
...
\033[1;91m☞ Auther     : KRISHNA_LGD
\033[1;92m☞ WhatsApp   : +971567957226
\033[1;95m☞ YouTube    : https://youtube.com/channel/UCLO6DN08rVxsCB7CniUxtEA
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update KRISHNA_LGD Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' KRISHNA_LGD WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/KRISHNA_LGD')
	    os.system('cd $HOME && git clone https://github.com/krishna24/Legend')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('WhatsApp Num 971567957226✓')
	    psb('WellCome To KRISHNA_LEGEND')
	    psb('Congratulations KRISHNA_LGD Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ 786786✓')
	    psb('🔓Password ☆ 786786✓')
	    psb('Subscrib My Youtube Channel KRISHNA_LGD✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/KRISHNA_LGD && python2 LGD.py')
	elif bm =='3':
	    os.system('xdg-open https://chat.whatsapp.com/L5DOtOr5XPuLdG65OPmrpT')
	    menu()
	elif bm =='4':
